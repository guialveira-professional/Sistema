...
from companies.utils.permissions import EmployeesPermissions, GroupsPermission
...
class Employees(Base):
    ...
    def get(self, request):
        ...
        employees = Employee.objects.filter(enterprise_id=enterprise_id).exclude(user_id=owner_id).all() #Remove o dono da listagem de funcionários
    ...
    def post(self,request):
        ...
        signup_user = Authentication.signup(self,
            name=name,
            email=email,
            password=password,
...
class EmployeeDetail(Base):
    ...
    def delete(self,request, employee_id):
        ...
        if check_if_owner:
            raise APIException('Dono da empresa não pode ser deletado')
