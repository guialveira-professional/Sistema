...
Neste projeto foram desenvolvidas as APIs para um sistema de gestão empresarial com autenticação utilizando Django e Rest Framework


## ⛏️ Instalação

Instale as dependências do arquivo `requirements.txt` utilizando o comando `pip` em seu ambiente virtual
